...
#
#     PHX_SERVER=true bin/feed_service start
#
...
# Runtime overrides applied in all envs when the variable is set.
# In :prod the variables below are required (see the `:prod` block).
